...
class TestQuestionService:
    ...
    def service(self, mock_repo):
        return QuestionService(mock_repo)

    @pytest.fixture
    def sample_question(self):
        """Фикстура для создания полного вопроса"""
        return Question(
            id=uuid4(),
    ...
    def test_service_creates_question(self, service, mock_repo):
        """ТЕСТ: Сервис корректно создает вопрос"""
        student_id = uuid4()
    ...
    def test_service_answers_question(self, service, mock_repo, sample_question):
        """ТЕСТ: Сервис корректно отвечает на вопрос"""
        # Используем sample_question как базовый объект
    ...
    def test_service_closes_question(self, service, mock_repo, sample_question):
        """ТЕСТ: Сервис корректно закрывает вопрос"""
